...
| <a name="input_mutual_authentication"></a> [mutual\_authentication](#input\_mutual\_authentication) | Map of mutual authentication configuration to create. Valid only for secure listerners. | `any` | `{}` | no |
