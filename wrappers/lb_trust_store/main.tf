module "wrapper" {
  ...
  create_trust_store                       = try(each.value.create_trust_store, var.defaults.create_trust_store, true)
  ...
  trust_store_arn                          = try(each.value.trust_store_arn, var.defaults.trust_store_arn, null)
}
