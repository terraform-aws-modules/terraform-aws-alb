module "wrapper" {
  ...
  access_logs                                                  = try(each.value.access_logs, var.defaults.access_logs, null)
  additional_target_group_attachments                          = try(each.value.additional_target_group_attachments, var.defaults.additional_target_group_attachments, null)
  ...
  connection_logs                                              = try(each.value.connection_logs, var.defaults.connection_logs, null)
  ...
  ipam_pools                                                   = try(each.value.ipam_pools, var.defaults.ipam_pools, null)
  ...
  route53_records                                              = try(each.value.route53_records, var.defaults.route53_records, null)
  security_group_description                                   = try(each.value.security_group_description, var.defaults.security_group_description, null)
  security_group_egress_rules                                  = try(each.value.security_group_egress_rules, var.defaults.security_group_egress_rules, null)
  ...
  target_groups                                                = try(each.value.target_groups, var.defaults.target_groups, null)
